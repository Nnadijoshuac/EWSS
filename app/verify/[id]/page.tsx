        ...
        <div className="max-w-2xl">
          ...
          <div className="card border-4 border-green-400 bg-green-50 mb-8 text-center">
            ...
            <p className="text-green-800">
              This water source has been verified and registered with AquaTrust
            </p>
          </div>
          ...
          <div className="card mb-8">
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
              ...
              <ul className="text-xs text-blue-900 space-y-1">
                <li> Registered with AquaTrust on Jan 15, 2024</li>
            ...
            <ul className="space-y-2 text-sm text-green-900">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-75">
                    Report issues and get support from AquaTrust
                  </p>
                </div>
              </li>
            </ul>
